...
/** Método .findIndex():
    Devuelve el ÍNDICE del primer elemento de un array que cumpla con la condición definida
    en la función proporcionada.
    En caso de que ningún elemento de la matriz cumpla con la condición, devuelve -1.

    Nota: Si necesitas el VALOR del elemento encontrado en el array, utiliza find().
*/